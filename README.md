## Ubuntu Dedicated Server Quickstart

Fresh Ubuntu install (installs Docker + runs the full stack):
...
Default ports: telnet `4000` (dillfrog) and `4040` (fuzzem). Web UI on `8080`.

Linux/Docker details: `docker/README.md`.
...
[![Product Name Screen Shot][product-screenshot]](https://www.doyometer.com)
...
_For more examples, please refer to the [Documentation](https://www.doyometer.com)_

...
#   confess "Probably want to supply db name" unless $db_name;
   ...
   my $datasource = $main::db_datasource || "DBI:MariaDB:database=$db_name;host=$main::db_host";
  ...
  # print "localhost\n";
  # &main::rock_shout(undef, "Connection to Database @ localhost.\n", 1); 
   return DBI->connect_cached($datasource, $id, $pass, {'RaiseError' => 1, 'ChopBlanks' => 1, 'AutoCommit' => 1});
}
